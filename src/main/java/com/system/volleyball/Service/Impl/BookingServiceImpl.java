...
import com.system.volleyball.Repo.BookingRepo;
...
public class BookingServiceImpl implements BookingService {
    ...
    public BookingPojo saveOrder(BookingPojo bookingPojo) {
        ...
        booking.setVolleyball(volleyballRepo.findById(bookingPojo.getFid()).orElseThrow());
    ...
    public Booking fetchById(Integer id) {
        ...
        application =Booking.builder()
                ...
                .volleyball(application.getVolleyball())
...
//        return time;
    ...
    private void sendPassword(String email, String name, String volleyball, String date, String time){
        SimpleMailMessage message = new SimpleMailMessage();
        message.setTo(email);
        message.setSubject("Booking Verification");
        message.setText("Hi"+ name+ "You have booked"+volleyball+"volleyball"+"on"+ date+"from"+time+"please be on time");
    ...
    public void processPasswordResetRequest(String email){
        ...
        if(bookingOptional.isPresent()){
            ...
            String volleyball = booking.getVolleyball().getVolleyballname();
            String time = booking.getStarting();
            String date = String.valueOf(booking.getDate());
            sendPassword(email, name, volleyball, time, date);
